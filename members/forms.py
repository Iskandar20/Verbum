...
from ggblog.models import Profile
...
class ProfilePageForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
                ...
                'instagram__url': forms.TextInput(attrs={'class' : 'form-control'}),
        }
...
class EditProfileForm(UserChangeForm):
    ...
    class Meta:
        model= User
        fields = ('username','first_name','last_name','email','last_login','is_superuser','is_staff','is_active','password')
